...
\begin{itemize}
\item A function is convex when a line joining two points never interects anywhere else.
...
\begin{itemize}
    ...
    \end{myalign*}
    \item Belief: $\beta_i(\*C_i) = \psi_i \times \prod_{k \in \N_i} \delta_{k \rightarrow i}$
\end{itemize}
